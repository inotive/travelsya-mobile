...
import 'package:travelsya/app/health/widgets/health_info_praktek_section.dart';
...
class _HealthDetailPageState extends State<HealthDetailPage> {
  ...
  String getFilterData(int index) {
    ...
    if (index == 0) {
      ...
      return 'Jadwal Praktek';
    } else if (index == 2) {
      returnValue = 'Lokasi';
    } else if (index == 3) {
      returnValue = 'Layanan Kesehatan';
    } else if (index == 4) {
      returnValue = 'Review';
    }
              ...
              child: ScrollablePositionedList.builder(
                ...
                itemBuilder: (context, index) {
                  if (index == 0) {
                    ...
                    return const HealthInfoPraktekSection();
                  } else if (index == 2) {
                    return const RekreasiLocationSection();
                  } else if (index == 3) {
                    return const HealthPackageSection();
                  } else if (index == 4) {
