...
class PLNInquiryTokenSheet extends StatefulWidget {
  final PPOBModel data;
  final String pelangganNumber;
  final String uniqueCode;

  const PLNInquiryTokenSheet(
      {super.key,
      required this.data,
  ...
  @override
  State<PLNInquiryTokenSheet> createState() => _PLNInquiryTokenSheetState();
}

class _PLNInquiryTokenSheetState extends State<PLNInquiryTokenSheet> {
  bool usePoint = false;
            ...
            children: [
              ...
              Expanded(
                ...
                children: [
                  ...
                  FormHelper.splitRow(
                      data: widget.pelangganNumber, title: 'No Pelanggan'),
                  SizedBox(
                    height: margin8,
                  ),
                  Text(
                      ...
                      builder: (context, state) {
                        if (state is FeeAdminLoading) {
                          ...
                          double finalData = getAdminFeeByService(context,
                              'listrik-token', double.parse(widget.data.price));
                      ...
                      children: [
                        ...
                        Text(
                          moneyChanger(double.parse(widget.data.price) +
                              getAdminFeeByService(context, 'listrik-token',
