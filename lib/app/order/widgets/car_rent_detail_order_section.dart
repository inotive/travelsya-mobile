...
class CarRentDetailOrderSection extends StatelessWidget {
  final CarRentOrderDetailModel data;
  const CarRentDetailOrderSection({super.key, required this.data});
