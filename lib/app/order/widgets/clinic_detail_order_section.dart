...
class ClinicDetailOrderSection extends StatelessWidget {
  final ClinicOrderDetailModel data;
  const ClinicDetailOrderSection({super.key, required this.data});
