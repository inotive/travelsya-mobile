...
class _HostelDetailRoomSection extends StatelessWidget {
  final HostelDetailModel data;
  final String duration;

  const _HostelDetailRoomSection({required this.data, required this.duration});
                  ...
                  List<Map<String, String>> dataFacility = [
                    {
                      ...
                      'title': data.room[index].guest == '0'
                          ? 'Tidak Ada batasan'
                          : '${data.room[index].guest} Tamu'
                    },
                    {
                                      ...
                                      Expanded(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            width: double.infinity,
                                            child: Text(
                                              '/unit/${duration == 'Bulanan' ? 'Bulan' : 'Tahun'} (termasuk pajak)',
                                              style: mainBody5.copyWith(
                                                  color: neutral70),
                                            ),
                                          )
